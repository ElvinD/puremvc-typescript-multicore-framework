...
*/
declare module puremvc {
    class AsyncCommand extends puremvc.SimpleCommand implements puremvc.IAsyncCommand {
        private onComplete;
        /**
...
*/
declare module puremvc {
    class AsyncMacroCommand extends puremvc.Notifier implements puremvc.IAsyncCommand, puremvc.INotifier {
        /**
