        ...
        */
        function AsyncMacroCommand() {
            ...
            this.nextCommand = function () {
                if (_this.subCommands.length > 0) {
                    var commandClassRef = _this.subCommands.shift();
                    var commandInstance = new commandClassRef();
                    var isAsync = typeof commandInstance.commandComplete == "function";
                    if (isAsync) {
                        commandInstance.setOnComplete(_this.nextCommand);
                    }
                    commandInstance.initializeNotifier(_this.multitonKey);
                    commandInstance.execute(_this.note);
                    if (!isAsync) {
                        _this.nextCommand();
                    }
                }
...
//# sourceMappingURL=puremvc-typescript-multicore-1.1.js.map